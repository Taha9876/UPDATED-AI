...
import { HomeIcon, SettingsIcon, MicIcon, CodeIcon, GlobeIcon, LayoutGridIcon } from "lucide-react"
    ...
    <Card className={cn("h-full w-64 flex flex-col", className)} {...props}>
      <CardContent className="flex-1 py-4">
        <div className="flex items-center gap-2 px-4 mb-6">
          ...
          />
          <h2 className="text-lg font-semibold">Voice Automation</h2>
        </div>
...
const SidebarHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("flex items-center justify-between border-b px-4 py-3", className)} {...props} />
  ),
)
